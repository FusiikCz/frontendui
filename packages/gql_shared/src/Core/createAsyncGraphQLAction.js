        ...
        return async (dispatch, getState, next = (jsonResult) => jsonResult) => {
            try {
                ...
                if (jsonResult.errors && Array.isArray(jsonResult.errors)) {
                    ...
                    console.error("createAsyncGraphQLAction: Full response:", jsonResult);
                    console.error("createAsyncGraphQLAction: Query:", graphQLQuery);
                    console.error("createAsyncGraphQLAction: Variables:", graphQLVariables);
