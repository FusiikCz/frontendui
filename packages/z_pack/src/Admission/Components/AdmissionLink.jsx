...
export const AdmissionLink = ({admission, ...props}) => {
    const url = AdmissionURI + "995a0dd2-3697-4e40-ae68-5bc3d9fe8c81";
    console.log('AdmissionLink generating URL:', url);
    return <ProxyLink to={url} {...props}>{admission.name}</ProxyLink>
}