...
import { generateRandomStudents } from '../Data/studentData'
...
/**
 * Renders the navigation bar for a Student page.
 *
 ...
 * if a `student` object is provided. It also includes a generate button to create
 * random students.
 *
 * @component
 ...
 * @param {Function} props.onGenerateStudents - Callback function to handle generating random students.
 *
 ...
 * />
 */
export const StudentPageNavbar = ({ student, onSearchChange, onGenerateStudents }) => {
    ...
    const handleGenerateClick = () => {
        const randomStudents = generateRandomStudents(5);
        if (onGenerateStudents) {
            onGenerateStudents(randomStudents);
        } else {
            console.log('Generated students:', randomStudents);
        }
    };
    ...
    return (
        ...
        <MyNavbar onSearchChange={onSearchChange} >
            ...
            <Nav.Item style={{ marginLeft: '16px' }}>
                <Button 
